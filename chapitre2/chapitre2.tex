...
\bottomcaption{ Comparison of generalization errors obtained with selected methods: the overall smallest error is indicated in \textbf{italic} digits; the smallest error between IDDTW and FDTW is indicated in \textbf{bold} digits.  \textbf{N }is the number of segments selected
